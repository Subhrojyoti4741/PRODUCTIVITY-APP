      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text("Create Account", style: TextStyle(color: Colors.white, fontSize: 32, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
              SizedBox(height: 8),
              Text("Join FocusGuard to level up your life", style: TextStyle(color: Colors.grey, fontSize: 16), textAlign: TextAlign.center),
              SizedBox(height: 48),
              TextField(
